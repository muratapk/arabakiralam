...
namespace arabakiralam.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public RentalsController(RentCarDb context)
        {
            _context = context;
        }
        ...
        {
            var rentCarDb = _context.Rentals.Include(r => r.Car).Include(r => r.Customer);
        ...
        public async Task<IActionResult> Create([Bind("RentalId,CarId,CustomerId,RentDate,ReturnDate,TotalPrice")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RentalId,CarId,CustomerId,RentDate,ReturnDate,TotalPrice")] Rental rental)
        {
